...
public class QueryPurchaseIndexDto extends DrugPageBean {
    ...
    public String getSupplyStaus() {
        return supplyStaus;
    }

    public void setSupplyStaus(String supplyStaus) {
        this.supplyStaus = supplyStaus;
    }
